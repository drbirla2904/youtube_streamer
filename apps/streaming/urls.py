"""
urls.py â€” URL patterns for the streaming app.

No route changes needed.  stream_start now requires POST (enforced in the view).
"""
...
urlpatterns = [
    # â”€â”€ YouTube OAuth â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    path('connect/', views.connect_youtube, name='connect_youtube'),
    path('oauth2callback/', views.oauth_callback, name='oauth_callback'),

    # â”€â”€ Streams â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # OPTIONAL: pre-download playlist videos to S3
    path(
        'streams/<uuid:stream_id>/download-playlist/',
    ...
    # â”€â”€ Playlist APIs â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    # Note: these two paths must come BEFORE the generic <uuid:stream_id>
    # patterns above so Django resolves them correctly.
    path('streams/api/playlists/', views.user_playlists_api, name='user_playlists'),
    path(
        'streams/api/playlist/<str:playlist_id>/videos/',
        views.playlist_videos_api,
        name='playlist_videos',
    ),
    path(
        'streams/playlist/<str:playlist_id>/fetch/',
        views.fetch_playlist_task,
        name='fetch_playlist_task',
    ),
